...
import net.wurstclient.clickgui.screens.EditStringListScreen;
import net.wurstclient.settings.StringListSetting;
import org.lwjgl.opengl.GL11;

public final class StringListEditButton extends Component
{
	private final StringListSetting setting;
	private int buttonWidth;
	
	public StringListEditButton(StringListSetting setting)
	{
	...
	public void handleMouseClick(double mouseX, double mouseY, int mouseButton)
	{
		...
		WurstClient.MC.openScreen(
			new EditStringListScreen(WurstClient.MC.currentScreen, setting));
	}
		...
		float partialTicks)
	{
		...
		TextRenderer fr = WurstClient.MC.textRenderer;
		String text = setting.getName() + ": " + setting.getValues().size();
